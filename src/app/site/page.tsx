...
import { pricingCards } from "@/utils/pricings";
import {
  Card,
  CardContent,
  CardDescription,
    ...
    <main className="">
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <div className="flex justify-center items-center relative md:mt-[-70px]">
          ...
          <div className="bottom-0 top-1/2 bg-gradient-to-t dark:from-background left-0 right-0 absolute z-10" />
        </div>
      </section>
      ...
      <section className="flex justify-center flex-col gap-4 md:!mt-20 mt-[-40px]">
        ...
        <div className="flex justify-center gap-4 flex-wrap mt-6">
          {pricingCards.map((card) => (
            // TODO: Integrate with stripe and add free product
            <Card
              key={card.title}
